<template>
	...
	>
		<div class="max-w-[760px] mx-auto flex flex-col gap-6">
			<div class="text-xl font-semibold text-text-main">
				我的个人名片（测试模块）
			</div>
			<div
				class="rounded-2xl border border-border-default/80 bg-page-bg/80 p-5"
			>
				...
				<div class="grid grid-cols-2 gap-3 mt-4 text-sm">
					<div
						class="rounded-xl bg-card-bg border border-border-default p-3"
					>
					...
					<div
						class="rounded-xl bg-card-bg border border-border-default p-3 col-span-2"
					>
						<div class="text-gray-500 dark:text-gray-300">电话</div>
						<div class="text-text-main mt-1">
							{{ user.phone || '-' }}
						</div>
					</div>
					<div
