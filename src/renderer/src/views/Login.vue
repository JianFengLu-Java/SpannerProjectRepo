  ...
  <div class="h-full w-full justify-center flex items-center">
    ...
    <div class="justify-center flex w-full h-full bg-amber-50 ">
      <form class="flex flex-col h-full w-full gap-3">
        <div class="flex flex-col h-full pt-20 p-6 items-center gap-3 bg-gray-50">
          ...
          <div class="gap-2 mt-2 flex flex-col w-full">
            <n-button type="primary" class="w-full " :render-icon="okIcon" @click="handleLogin">登录</n-button>
            <n-button type="primary" class="w-full " color="#10b981" :render-icon="registerIcon"
              @click="handleRegister">注册</n-button>
          </div>
