<template>
	<div
		class="w-[76px] gap-3 h-full flex flex-col items-center justify-between rounded-[14px]"
	>
		...
		>
			...
			<div
				...
				:key="item.key"
				:class="[
					'flex flex-col items-center justify-center gap-1 h-14 w-16 cursor-pointer rounded-lg transition-all no-drag',
			...
			>
				...
				<n-badge :dot="item.hasMessage" color="red" size="small">
					<div
						class="h-8 w-8 flex flex-col gap-1 justify-center items-center"
					>
						<n-icon
							size="18"
